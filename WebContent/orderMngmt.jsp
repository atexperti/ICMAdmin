  ...
  <div class="main_content">
    <div class="menu">
      <ul>
        ...
        <li><a class="current" href="order.html">	Order Management </a></li>
		<li><a  href="user.html"> User Management </a></li>
		<li><a  href="ticketmngt.html"> Ticket Managemnet </a></li>
          <!--<![endif]-->
        ...
        <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
          <thead>
            <tr>
			  ...
			  <th scope="col" class="rounded">Order No</th>	
              <th scope="col" class="rounded"> Order Type</th>
